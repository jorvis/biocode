...
def print_biogene( gene=None, fh=None, on=None, obo_dict=None, lab_name=None ):
    ...
    gene_coords = biocodeutils.interbase0_to_humancoords(gene_loc.fmin, gene_loc.fmax, gene_loc.strand)
    ...
    for RNA in gene.RNAs():
        ...
        for exon in exons:
            ...
            exon_coords = biocodeutils.interbase0_to_humancoords(exon_loc.fmin, exon_loc.fmax, exon_loc.strand)
        ...
        for CDS in CDSs:
            ...
            CDS_coords = biocodeutils.interbase0_to_humancoords(CDS_loc.fmin, CDS_loc.fmax, CDS_loc.strand)
